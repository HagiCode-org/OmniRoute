...
| `OMNIROUTE_LOG_DIR`                    | `./logs`             | `ecosystem.config.cjs`, `scripts/pm2/common.sh`       | Repo-local log directory used by the PM2 production wrapper. Stores PM2 stdout/stderr files for `omniroute-service`.                                                                                                                            |
| `OMNIROUTE_RUNTIME_DIR`                | `./runtime`          | `ecosystem.config.cjs`, `scripts/pm2/common.sh`       | Repo-local runtime metadata directory used by the PM2 production wrapper for lockfiles and future install metadata.                                                                                                                             |
...
| `OMNIROUTE_PM2_PORT`                        | `36129`                         | `ecosystem.config.cjs`                                                   | Default port used by the repo-local PM2 wrapper when `PORT` is not explicitly exported into the PM2 process environment.                                       |
